...
class BlogNode:
    ...
    def __init__(self, llm):   # in every node implementation we also require an llm
        self.llm = llm
        
        
    def title_creation(self, state:BlogState):       # whenever we write any node implementation we have to give a state
        """
        ...
        if "topic" in state and state["topic"]:
            prompt = """
                    ...
                    Generate a blog title for the {topic}. This title should be creative and SEO
            """
    ...
    def translation(self, state:BlogState):
        """
        Translating the content to the specified language
        """
